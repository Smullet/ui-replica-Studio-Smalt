...
export const Hero: React.FC = () => {
  return (
    <section className="w-full relative bg-white">
      <div className="flex w-full h-[789px] flex-col justify-center items-center gap-5 shrink-0">
        <img
      ...
      <div className="flex w-full flex-col justify-center items-center bg-[#F6F7F9] px-0 py-24">
        <img
      ...
      <img
        ...
        alt="Introduction"
        className="flex w-full flex-col justify-center items-center gap-12"
      />
    </section>
  );
};
