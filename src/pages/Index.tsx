...
export default function Index() {
  return (
    <main className="min-h-screen bg-white overflow-x-hidden">
      ...
      {/* Circle decorations - Hidden on mobile for better performance */}
      <div className="hidden md:block fixed pointer-events-none z-[-1]">
      ...
      <div className="hidden md:block fixed pointer-events-none z-[-1] right-0">
